...
public class RegistrationService {
  ...
  public Course createCourse(String courseName, int capacity) {
    ...
    System.out
        .println("Course created: " + courseName + " (ID: C" + course.getCourseId() + ", Capacity: " + capacity + ")");
    return course;
  }
  ...
  public boolean enrollStudentInCourse(Student student, Course course) {
    ...
    if (course.addStudent(student)) {
      ...
      System.out.println(
          "Failed to enroll student " + student.getName() + " in " + course.getCourseName() + ". Course is full.");
      return false;
    }
  }
